#NOTES:
/* Create a Secuirty Group Then allow APP subnets to SG ingress Then attach
Security group to aws_docdb_cluster.  which establish connection to DOCDB */
...
resource "aws_docdb_cluster" "main" {
  ...
  #add SG to establish connection to document db
...
##This Securigy group helps to connect DOCUMEnt DB
